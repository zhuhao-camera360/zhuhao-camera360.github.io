			        ...
			        getHtml: function (data) {
			            if (data == "") {
			                return "";
								...
								&& data.indexOf("<body") =="=" -1)="" {="" return="" data;="" }="" var="" posbodystart="data.indexOf("<body");" if="" (posbodystart=""> 0) {
			                posBodyStart += data.match(/<body[^>]*>/gi)[0].length;
			            } else {
			                posBodyStart = 0;
			            }
			            var posBodyStartEnd = data.indexOf("]*href=[\"\' ][^\"\' ]*/gi);
			            var js = data
								.match(/<scrip[^>]*src=[\"\' ][^\"\' ]*/gi);
			            ...
			            while (css && css.length) {
			                var css1 = css.shift().replace(
									/<link.*?href=[\"\' ]="" i,="" "");="" if="" (link.indexof(css1)="=" -1)="" {="" $("head")="" .append(="" '<link="" href="'
														+ css1
								...
								function () {
								    while (js && js.length) {
								        var js1 = js.shift().replace(
												/<scrip.*?src=[\"\' ]="" i,="" "");="" if="" (script.indexof(js1)="=" -1)="" {="" $("head")="" .append(="" '<scr'="" +="" 'ipt="" src="'
																	+ js1
...
})(jQuery);</scrip.*?src=[\"\'></link.*?href=[\"\'></\></scrip[^></link[^></scrip[^></body[^></body")>